  ...
  return {
    ...
    execute: function () {
      ...
      _export("RPath", RPath = (_dec = ccclass('RPath'), _dec(_class = class RPath extends Component {
        ...
        _applyStyle() {
          let ctx = this.ctx; // console.log(this.getStyled('lineWidth'),' this.getStyled()')
          // 默认是 1，看不清，固写死测试
        ...
        fitCubic(first, last, tan1, tan2) {
          ...
          for (let i = 0; i <= 4; i++) {
            let curve = this.generateBezier(first, last, uPrime, tan1, tan2); //  Find max deviation of points to fitted curve
        ...
        generateBezier(first, last, uPrime, tan1, tan2) {
          ...
          if (alpha1 < eps || alpha2 < eps) {
            ...
            let line = pt2.sub(pt1); // Control points 1 and 2 are positioned an alpha distance out
        ...
        evaluate(degree, curve, t) {
          // Copy array
          let tmp = curve.slice(); // Triangle computation
...
//# sourceMappingURL=57c604953eacd1e2f8dd0ab12f3ebecbeaf106cc.js.map