System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, path2absolute, path2curve, _crd, pathCommand, pathValues, concat, apply, split, has, toFloat, mmax, mmin, PI, abs, math, pow, upperCase, cache, a2c, l2c, q2c, parsePathString;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "3fbadXGNktLUK9UR599v4aj", "R.curve", undefined);
      ...
      parsePathString = function parsePathString(pathString) {
        if (!pathString) {
          return null;
        }
      ...
      _export("path2absolute", path2absolute = class path2absolute {
      ...
      _export("path2curve", path2curve = class path2curve {
...
//# sourceMappingURL=dfdd1f3295238fe0e7140a1a4b482ed28716a818.js.map