      ...
      _export("Nardove", Nardove = (_dec = ccclass('Nardove'), _dec(_class = (_class2 = class Nardove extends Component {
        ...
        update(dt) {
          ...
          if (this.time >= this.addJellyTimer && this.jellyCounter < this.numJellies) {
            var jelly = new (_crd && Jelly === void 0 ? (_reportPossibleCrUseOfJelly({
              error: Error()
            }), Jelly) : Jelly)();
          ...
          for (var i = 0, ii = this.jellies.length; i < ii; i++) {
            var _jelly = this.jellies[i];

            _jelly.update(this.time, this.count);
          }
        }
...
//# sourceMappingURL=872e1a5647d262d90204d29863a97b9825e40f4a.js.map