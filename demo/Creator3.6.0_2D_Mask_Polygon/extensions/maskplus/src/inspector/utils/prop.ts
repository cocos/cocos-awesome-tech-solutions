...
export function sortProp(propMap: any) {
    const orderList: any[] = [];
 ...
 */
export function updateCustomPropElements(container: any, excludeList: any, dump: any, update: any) {
    ...
    currentChildren.forEach(($child: any) => {
 ...
 */
export function loopSetAssetDumpDataReadonly(dump: any) {
 ...
 * @param element
 */
export function setDisabled(data: any, element: any) {
    if (!element) {
        return;
    }
 ...
 * @param element
 */
export function setReadonly(data: any, element: any) {
    if (!element) {
        return;
    }
 ...
 */
export function setHidden(data: any, element: any) {
    if (!element) {
        return;
    }
...
export function updatePropByDump(panel: any, dump: any) {
    panel.dump = dump;
 ...
 */
export function isMultipleInvalid(dump: any) {
    let invalid = false;
 ...
 * @returns 
 */
export function getName(dump: any) {
    if (!dump) {
        return '';
    }
    ...
    name = name.replace(/^\S/, (str: any) => str.toUpperCase());
    name = name.replace(/_/g, (str: any) => ' ');
    name = name.replace(/ \S/g, (str: any) => ` ${str.toUpperCase()}`);

    return name.trim();
};

export function setTooltip(element: any, dump: any) {
    if (dump.tooltip) {
...
* name and tooltip
*/
export function setLabel($label: any, dump: any) {
    if (!dump) {
        // @ts-ignore
        dump = this.dump;
    }
