System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, _dec, _class, _crd, ccclass, property, Canvas2Image;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "99156FN08ZIrL3VOfOBRNam", "Canvas2Image", undefined);
      ...
      _export("Canvas2Image", Canvas2Image = (_dec = ccclass('Canvas2Image'), _dec(_class = class Canvas2Image {
        static getInstance() {
          ...
          var saveAsImage = function saveAsImage(canvas, width, height, type, fileName) {
            ...
            if ($support.canvas && $support.dataURL) {
              ...
              if (/bmp/.test(type)) {
                ...
                canvas = scaleCanvas(canvas, width, height); // 如果
          ...
          var fileDownload = function fileDownload(downloadUrl, type, fileName) {
            ...
            aLink.download = fileName + "." + type; // 触发点击-然后移除
...
//# sourceMappingURL=Canvas2Image.js.map