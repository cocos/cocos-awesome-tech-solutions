System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Vec3, Mat4, systemEvent, SystemEventType, CameraComponent, geometry, PhysicsSystem, utils, ColliderComponent, BoxColliderComponent, MeshColliderComponent, RigidBodyComponent, MeshRenderer, Mesh, FastHull, _dec, _dec2, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, TouchSplit;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'Vec2', 'Vec3', 'Mat4', 'systemEvent', 'SystemEventType', 'Touch', 'CameraComponent', 'geometry', 'PhysicsSystem', 'ModelComponent', 'instantiate', 'utils', 'ColliderComponent', 'BoxColliderComponent', 'MeshColliderComponent', 'RigidBodyComponent', 'MeshRenderer', 'Mesh', 'assetManager', 'resources', 'Material']);
      ...
      _export("TouchSplit", TouchSplit = (_dec = ccclass('TouchSplit'), _dec2 = property(CameraComponent), _dec(_class = (_class2 = class TouchSplit extends Component {
        ...
        splitMesh(splitNode, plane) {
          ...
          let modelMesh = meshRender == null ? void 0 : meshRender.mesh;
          ...
          let splitMaterial = meshRender == null ? void 0 : meshRender.sharedMaterial;
...
//# sourceMappingURL=2ff2e66d574f01e7d8a936ce6ab2cf0bacd720af.js.map